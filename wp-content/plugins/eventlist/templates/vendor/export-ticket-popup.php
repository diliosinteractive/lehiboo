...
<div id="el_export_ticket_popup" class="el_export_popup_wrapper overlay">
	<div class="el_export_container">
		<input type="hidden" name="ticket_ids" value="<?php echo json_encode( $ticket_ids ); ?>">
		<a href="#" class="el_close_popup" data-id="el_export_ticket_popup">&times;</a>
		<p class="description">
			<?php echo sprintf( __( 'There are a total of %d records', 'eventlist' ), count( $ticket_ids ) ); ?>
		</p>
